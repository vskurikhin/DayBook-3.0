...
psql -c "CREATE SUBSCRIPTION sub_test_users CONNECTION 'host=postgres-db-1.svn.su user=replicator pgdbname=db password=replicator_password' PUBLICATION pub_test_users;" -U pguser pgdb
