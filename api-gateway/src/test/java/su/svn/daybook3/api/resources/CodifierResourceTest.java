...
import su.svn.daybook3.api.services.models.CodifierService;
...
class CodifierResourceTest {
    ...
    void setUp() {
        ...
        Mockito.when(mock.add(any())).thenReturn(TestData.uuid.UNI_ANSWER_API_RESPONSE_ZERO);
        Mockito.when(mock.put(any())).thenReturn(TestData.uuid.UNI_ANSWER_API_RESPONSE_ZERO);
        Mockito.when(mock.delete(any())).thenReturn(TestData.uuid.UNI_ANSWER_API_RESPONSE_ZERO);
