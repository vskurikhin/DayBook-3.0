...
public class I18nTransactionalJob extends AbstractOneToOneJob<Long, I18nTable, Long, LanguageTable, String> {
    ...
    @Override
    protected Function<RowIterator<Row>, Optional<?>> iteratorNextFunctionMapper(String actionName) {
    ...
    @Override
    protected Function<Optional<?>, Optional<Long>> oToG() {
        return o -> o.flatMap(l -> (l instanceof Long result) ? Optional.of(result) : Optional.empty());
    }

    @Override
    protected Function<Optional<?>, Optional<Long>> oToI() {
        return o -> o.flatMap(l -> (l instanceof Long result) ? Optional.of(result) : Optional.empty());
    }
}
