...
public class UserServiceTest {
    ...
    void setUp() {
        ...
        // userTransactionalJobMock = Mockito.mock(UserTransactionalJob.class);
        ...
        // QuarkusMock.installMockForType(userTransactionalJobMock, UserTransactionalJob.class);
    }
    ...
    void testWhenGetThenEntry() {
        Mockito.when(userViewDaoMock.findById(TestData.ZERO_UUID)).thenReturn(UNI_OPTIONAL_TEST);
...
//
//    @Test
//    void testWhenAddThenId() throws InterruptedException {
//        var test = new User(
//                TestData.ZERO_UUID, "guest", "password", Collections.emptySet(), true, 0
//        );
