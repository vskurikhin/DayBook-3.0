...
class I18nServiceTest {
    ...
    void testWhenGetAllThenSingletonList() {
        ...
        Assertions.assertDoesNotThrow(() -> result.addAll(service.getAll()
                .subscribe()
                .asStream()
                .peek(actual -> Assertions.assertEquals(Answer.of(TestData.I18N.TABLE_0), actual)).toList()));
    ...
    void testWhenGetPageThenSingletonList() {
        ...
        var expected = Page.<Answer>builder()
                ...
                .prevPage(false)
                .nextPage(false)
                .content(Collections.singletonList(Answer.of(TestData.I18N.TABLE_0)))
                .build();
    ...
    void testWhenGetThenEntry() {
        Assertions.assertDoesNotThrow(() -> service.get(0L)
                .onItem()
                .invoke(actual -> Assertions.assertEquals(Answer.of(TestData.I18N.TABLE_0), actual))
                .await()
                .indefinitely());
    }
    ...
    void testWhenAddThenId() {
        var expected = Answer.builder()
                ...
                .build();
        Mockito.when(mock.insert(TestData.I18N.TABLE_0)).thenReturn(TestData.UNI_OPTIONAL_ZERO_LONG);
        Assertions.assertDoesNotThrow(() -> service.add(TestData.I18N.TABLE_0)
                .onItem()
                .invoke(actual -> Assertions.assertEquals(expected, actual))
                .await()
                .indefinitely());
    ...
    void testWhenAddThenEmpty() {
        Mockito.when(mock.insert(TestData.I18N.TABLE_0)).thenReturn(TestData.UNI_OPTIONAL_EMPTY_LONG);
        Assertions.assertDoesNotThrow(() -> service.add(TestData.I18N.TABLE_0)
                .onItem()
    ...
    void testWhenPutThenId() {
        var expected = Answer.builder()
                ...
                .payload(new ApiResponse<>(0L))
                .build();
        Mockito.when(mock.update(TestData.I18N.TABLE_0)).thenReturn(TestData.UNI_OPTIONAL_ZERO_LONG);
        Assertions.assertDoesNotThrow(() -> service.put(TestData.I18N.TABLE_0)
                .onItem()
                .invoke(actual -> Assertions.assertEquals(expected, actual))
                .await()
                .indefinitely());
    ...
    void testWhenPutThenEmpty() {
        Mockito.when(mock.update(TestData.I18N.TABLE_0)).thenReturn(TestData.UNI_OPTIONAL_ZERO_LONG);
        Assertions.assertThrows(RuntimeException.class, () -> service.put(TestData.I18N.TABLE_0)
                .onItem()
                .invoke(actual -> Assertions.assertEquals(Answer.empty(), actual))
                .await()
                .indefinitely());
