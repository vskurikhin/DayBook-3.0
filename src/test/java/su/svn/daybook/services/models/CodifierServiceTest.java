...
class CodifierServiceTest {
    ...
    void testWhenAddThenId() {
        var expected = Answer.builder()
                ...
                .error(201)
                .payload(new ApiResponse<>(CodifierTable.NONE, 201))
                .build();
    ...
    void testWhenPutThenId() {
        var expected = Answer.builder()
                .message(Answer.DEFAULT_MESSAGE)
                .error(202)
                .payload(new ApiResponse<>(CodifierTable.NONE, 202))
                .build();
    ...
    void testWhenDeleteThenId() {
        ...
        var expected = Answer.of(new ApiResponse<>(CodifierTable.NONE, 200));
