/*
 * This file was last modified at 2024-10-31 15:20 by Victor N. Skurikhin.
...
class UpdateHelper<
    ...
    private Uni<Optional<MainId>> updateMain(Map<String, Action> map, JoinId joinId) {
        var action = map.get(Constants.UPDATE_MAIN_TABLE);
        ...
        return super.connection
                ...
                .log("UpdateHelper.updateMain"); // todo remove
    }
}
